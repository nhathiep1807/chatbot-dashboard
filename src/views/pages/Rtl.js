      ...
      <div className="content">
        <Row>
          <Col className="text-center" lg="6" sm="6">
            <Card className="text-left card-tasks">
              <CardHeader>
                  ...
                  <Col xs="6">
                    <div className="card-stats justify-content-center">
                      <div className="d-flex justify-content-center align-items-center">
                        <span className="mt-3 ml-n4">على</span>
                        <CustomInput
                          type="switch"
                          id="switch-1"
                          defaultChecked
                        />
                        <span className="mt-3 mr-3">إيقاف</span>
                      </div>
              ...
              <CardBody>
                <ul className="timeline timeline-simple">
                  <li className="timeline-inverted">
                    ...
                    <div className="text-right timeline-panel">
                    ...
                    <div className="text-right timeline-panel">
                      ...
                      <div className="timeline-body">
                        <p>
                          ...
                          المباشر !!! أنا أحبك إلين وأيضا قاعدة بلدي رقم واحد
                          تصميم أي شيء أفعله من الأحذية إلى الموسيقى إلى
                          المنازل.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="text-right timeline-panel">
                      ...
                      <div className="timeline-body">
                        ...
                        <p>
                          ...
                          الدب القطبي ولكن الأريكة الدببة القطبية هي قطعة الأثاث
                          المفضلة لدينا التي نملكها. لم يكن أي مجموعة من على
                          أهدافه كاني
                        </p>
                        <hr />
                      </div>
        ...
        <Row>
          <Col lg="3" md="6">
            <Card className="card-pricing card-primary">
              ...
              <CardFooter className="mt-3 mb-3 text-center">
